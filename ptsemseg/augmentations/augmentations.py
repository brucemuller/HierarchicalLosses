...
class RandomScale(object):
    def __init__(self, rang=(0.7,2.0)):
        self.rang = rang
    ...
    def __call__(self, img, mask):
        ...
        #x1 = random.randint(0, w - tw)
        #y1 = random.randint(0, h - th)
        rn = random.uniform(1.0, 2.0)
        #print(rn)
        
        return (tf.affine(img, angle=0.0, translate=(0,0), scale = rn,shear=0.0,resample=Image.BILINEAR, fillcolor = (0, 0, 0)), tf.affine(mask, angle=0.0, translate=(0,0), scale = rn,shear=0.0,resample=Image.NEAREST, fillcolor = 0))
