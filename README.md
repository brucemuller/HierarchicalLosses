[A Hierarchical Loss For Semantic Segmentation (under review)](https://arxiv.org/) - [Bruce Muller](https://www.cs.york.ac.uk/cvpr/member/bruce/) and [William Smith](https://www.cs.york.ac.uk/cvpr/member/will/)

### Abstract

WORK IS STILL ONGOING. CURRENTLY UNDER REVIEW
